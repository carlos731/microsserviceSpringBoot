...
import com.microsservicechtsca.accounts.dto.AccountsDto;
...
import com.microsservicechtsca.accounts.exception.CustomerAlreadyExistsException;
...
import com.microsservicechtsca.accounts.service.IAccountsService;
...
public class AccountsServiceImpl implements IAccountsService {
    ...
    public void createAccount(CustomerDto customerDto) {
        ...
        validateNewEmailAndMobileNumber(customerDto);
    ...
    private void validateNewEmailAndMobileNumber(CustomerDto customerDto) {
        Optional<Customer> customer = customerRepository.findByEmail(customerDto.getEmail());
        if(customer.isPresent()) {
            throw new CustomerAlreadyExistsException("E-mail already registered: " + customerDto.getEmail());
        }

        customer = customerRepository.findByMobileNumber(customerDto.getMobileNumber());
        if(customer.isPresent()) {
